 ...
 * Si l'envio encriptada NO puc accedir llavors no puc accedir a l'aplicació. (No en se el motiu).
...
public class GestorEncrypt {
    ...
    public String RSAEncrypt(final String plain) throws NoSuchAlgorithmException, NoSuchPaddingException,
        ...
        String encryptedEscaped = Base64.encodeToString(encryptedBytes, Base64.DEFAULT);
        return StringEscapeUtils.escapeJava(encryptedEscaped);
    }
